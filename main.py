...
async def get_model_overview():
    ...
    rf_model, _, _ = load_model_artifacts(os.path.join(os.getcwd(), "model_artifacts"))
...
async def get_model_inference(item: Item):
    ...
    # Create a dataframe from the request body and replace underscores with hyphens in col names
    # NB This will only accept single dictionaries with scalar values
    # https://stackoverflow.com/questions/68771062/how-to-convert-a-pydantic-model-in-fastapi-to-a-pandas-dataframe
